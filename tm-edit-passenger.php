                        ...
                        <div class="container-fluid">
                            <div class="box box-bordered box-color">
                                ...
                                <div class="box-content nopadding">
                                    <form name="main-form" action="tm-edit-passenger-submit.php" method="POST"
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select onchange="updateStop();" name="route" id="select1"
                                                        class='input-large'>
                                                    <?php
                                                    require_once "praveenlib.php";
                                                    require_once "datas.php";
                                                ...
                                                <div id="loading" hidden="true">Loading stops..</div>
                                            </div>
                                        </div>
                                        <div id="stopsblock">
                                            <div class="control-group">
