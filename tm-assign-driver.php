...
if (isset($institutionId)) {
    ...
    if (isset($_POST['number']) && isset($_POST['driver'])) {
        ...
        if (mysqli_connect_errno()) //Check if any error occurred on connection
        {
            ...
            $sql = "update tm_employee set vehicle='" . $_POST['number'] . "' WHERE institute_id={$institutionId} && id=" . $_POST['driver'] . ";" . "update tm_vehicle_details set driver=" . $_POST['driver'] . " where institute_id={$institutionId} && number='" . $_POST['number'] . "';";
            ...
            <div class="container-fluid">
                <div class="box box-bordered box-color">
                    ...
                    <div class="box-content nopadding">
                        <form name="main-form"
                        " action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" class='form-horizontal form-bordered'>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <select name="driver" id="select2" class='input-large'>
                                    <?php
