...
?>
								...
								<table class="table table-hover table-nomargin table-bordered">
									<thead>
										<tr>
											...
											<th class='hidden-350'>End Location</th>
									...
									<?php
								        ...
								        else
								        {
											...
											{
												echo '<tr><td>'.$row['route_number'].'</td><td>'.$row['start_location']
													.'</td><td class="hidden-350">'.$row['end_location']
													.'</td><td class="hidden-480">'.$row['start_time']
													.'</td><td><button class="edit btn btn-warning" value="'.$row['route_number']
 ...
 <script>
	 $(".edit").click(function () {
		id=this.value;
		 window.location.href="tm-edit-route.php?id="+id;
	 });
