                                ...
                                <div class="box-content nopadding">
                                    <form name="main-form" action="tm-edit-vehicle-submit.php" method="POST"
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select name="type" id="select" class='input-large'>
                                                    ...
                                                    <option value="2" <?php if ($row['type'] == 2) echo "selected" ?> >
                                                        MINI BUS
                                                    </option>
                                                    <option value="3" <?php if ($row['type'] == 3) echo "selected" ?> >
                                                        VAN
                                                    </option>
                                                    <option value="4" <?php if ($row['type'] == 4) echo "selected" ?> >
                                                        CAR
                                                    </option>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="capacity" id="textfield"
