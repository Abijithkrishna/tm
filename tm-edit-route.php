...
if(mysqli_connect_errno()) //Check if any error occurred on connection
{
    ...
    if (isset($_GET['id'])) {
        ...
        $id = $_GET['id'];
        $query = "select * from tm_bus_route where institue_id={$institutionId} && route_number=" . $id ."  limit 1";
                                ...
                                <div class="box-content nopadding">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="bootstrap-timepicker input-append controls" style="display:block;">
                                            <input type="text" name="time" id="timepicker1" placeholder="" class="input-xlarge" value="<?php echo $row['start_time'] ?>">
