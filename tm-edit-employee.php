...
if (mysqli_connect_errno()) //Check if any error occurred on connection
{
    ...
    if (isset($_GET['id'])) {
        $id = $_GET['id'];
        $query = "select * from tm_employee where institute_id={$institutionId} && id='" . $id . "'  limit 1";
                        ...
                        <div class="container-fluid">
                            <div class="box box-bordered box-color">
                                ...
                                <div class="box-content nopadding">
                                    <form name="main-form" action="tm-edit-employee-submit.php" method="POST"
                                          class='form-horizontal form-bordered'>
                                        <div class="control-group">
                                            <label for="id" class="control-label">Employee Id</label>

                                            <div class="controls">
                                                <input type="text" name="id" id="textfield" placeholder=""
                                                       class="input-xlarge"
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select name="role" id="select" class='input-large'>
                                                    <option
                                                        value="driver" <?php if ($row['role'] == 'driver') echo "selected" ?>>
                                                        Driver
                                                    </option>
                                                    <option
                                                        value="conductor" <?php if ($row['role'] == 'conductor') echo "selected" ?>>
                                                        Conductor
                                                    </option>
                                                    <option
                                                        value="dirverconductor" <?php if ($row['role'] == 'dirverconductor') echo "selected" ?>>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="license" id="textfield" placeholder=""
                                                       class="input-xlarge"
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="expiry" id="textfield" placeholder=""
                                                       class="input-xlarge"
