...
<script>
	function send(){
		...
		var stop_number=document.forms['main-form']['stop-number'].value;
		var fee=document.forms['main-form']['fee'].value;
		var vehicle_number=document.forms['main-form']['vehicle-number'].value;


		$('button').attr('disabled',true);
		$.post("assign_student.php",{
