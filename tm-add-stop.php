            ...
            <div class="container-fluid">
                <div class="box box-bordered box-color">
                    ...
                    <div class="box-content nopadding">
                        <form name="main-form" method="POST" class='form-horizontal form-bordered'
                              onsubmit="return false;">
                            <div class="control-group">
                                <label for="stop-name" class="control-label">Stop Name</label>

                                <div class="controls">
                                    <input type="text" name="stop-name" id="textfield" placeholder=""
                                           class="input-xlarge">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="stop-number" id="textfield" placeholder=""
                                           class="input-xlarge">
                                </div>
                            </div>
                            <div class="control-group">
